...
import { Text, Button, Input, Icon, Card, Header, Left, Content, Right } from 'react-native-elements';
  ...
  render() {
    return (
      <View style={styles.container}>
        <Text h5 style={{ alignSelf: 'center', color: mediumBlue }}>Search for Cheap Flights</Text>
