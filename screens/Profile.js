  ...
  render() {
    return (
        <View style={styles.container}>
            <View style={{flex: 1}}>
              <ImageBackground source={require('../assets/images/background.jpg')} style={{flex: 1, height: "100%", width: "100%", justifyContent:"center", alignItems:"center"}}>

              <Text h4 style={{ color: white}}>Bayo</Text>
              <Text h4 style={{ color: white }}>bayokrapht@gmail.com</Text>
              <Text h5 style={{ color: white }}>08033412143</Text>
              <Button
                  buttonStyle={{
